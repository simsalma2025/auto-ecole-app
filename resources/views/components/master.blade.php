          ...
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              <li class="nav-section">
                ...
                <h4 class="text-section">GESTION DE LA PLATEFORME</h4>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#sidebarLayouts">
                  ...
                  <p style="color: white">Demande d'inscription</p>
                </a>   
              </li>
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#forms">
                <i class="fa-solid fa-users" style="color: white;"></i>
                  <p style="color: white;">Utilisateurs</p>
                </a>
              </li>
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#tables">
                    <i class="fa-solid fa-bookmark" style="color: white;"></i>
                  <p style="color: white;">Auto echole</p>
                </a>  
              </li>
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#maps">
                    <i class="fa-solid fa-chart-line" style="color: white;"></i>
                  <p style="color: white;">Statistique mensuelle</p>
                </a>
              </li>
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#charts">
                    <i class="fa-solid fa-compass" style="color: white;"></i>
                  <p style="color: white;">Exercices</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="widgets.html">
                 <i class="fa-solid fa-folder-open" style="color: white;"></i>
                  <p style="color: white;">Test & examens</p>
                </a>
              </li>
              <li class="nav-section">
                <span class="sidebar-mini-icon">
